...
namespace TheHardestGame.ConsoleUI
{
	internal class ConsoleDrawing
	{
		...
		public void DrawLevelBackground(int consoleHeight, int consoleWidth, int rectHeight, int rectWidth,
			ConsoleColor[][] colors)
		{
			...
			EngineRectangle bottomGray = new EngineRectangle(new EnginePoint(rectWidth*5, rectHeight*5),
			...
			EngineRectangle topWhite = new EngineRectangle(new EnginePoint(rectWidth*15, 0),
				new EngineSize(rectHeight, rectWidth));
			EngineRectangle bottomWhite = new EngineRectangle(new EnginePoint(rectWidth*4, rectHeight*5),
				new EngineSize(rectHeight, rectWidth));
			...
			EngineRectangle green2 = new EngineRectangle(new EnginePoint(rectWidth*16, 0),
