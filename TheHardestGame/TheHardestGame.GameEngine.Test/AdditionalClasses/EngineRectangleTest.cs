...
namespace TheHardestGame.GameEngine.Test.AdditionalClasses
{
	...
	public class EngineRectangleTest
	{
		...
		public void Constructor2Test()
		{
			...
			EngineRectangle er = new EngineRectangle(ep, es, 100);
		...
		public void CopyConstructorTest()
		{
			...
			Assert.AreEqual(er.LastOffset, er2.LastOffset);
		...
		{
			EngineRectangle er = new EngineRectangle(1.5, 4.2, 5.0, 3.3, 0, Directions.Up);
		...
		{
			EngineRectangle er = new EngineRectangle(1.5, 4.2, 5.0, 3.3, 0, Directions.Down);
		...
		{
			EngineRectangle er = new EngineRectangle(1.5, 4.2, 5.0, 3.3, 0, Directions.Left);
		...
		{
			EngineRectangle er = new EngineRectangle(1.5, 4.2, 5.0, 3.3, 0, Directions.Right);
